...
export class DayRepository implements IDayRepository {
  ...
  async getDaysRepository(programId: number, userId: number): Promise<WorkoutDayModel[]> {
  ...
  async createDayRepository(dto: DayDto, programId: number): Promise<WorkoutDayModel> {
