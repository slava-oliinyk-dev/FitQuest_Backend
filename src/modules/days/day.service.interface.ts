...
export interface IDayService {
	...
	createDayService: (programId: number, userId: number, dto: DayDto) => Promise<DayWithExercisesDto>;
	updateDayService: (programId: number, dayId: number, userId: number, dto: DayDto) => Promise<DayDto>;
