...
export class ExerciseEntity {
	...
	constructor(id: number, name: string, sets: number, repetitions: number, weight: number | null, restTime: number | null, note: string | null, progressMark: string | null, workoutDayId: number) {
		this.id = id;
		this.name = name;
		this.sets = sets;
